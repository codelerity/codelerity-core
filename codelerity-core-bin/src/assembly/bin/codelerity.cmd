...
"%JAVACMD%" "@%BASEDIR%\etc\java.cfg" %JAVA_OPTS% -p "%REPO%" -Dapp.name="codelerity" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" -m "com.codelerity.core.bin/com.codelerity.core.bin.Main" %CMD_LINE_ARGS%
