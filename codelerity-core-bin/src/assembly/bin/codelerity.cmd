@REM ----------------------------------------------------------------------------
@REM  Copyright (c) 2025 Codelerity Ltd.
@REM
...
"%JAVACMD%" %JAVA_OPTS% --add-modules=ALL-DEFAULT -p "%REPO%" -Dapp.name="codelerity" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" -m "com.codelerity.core.bin/com.codelerity.core.bin.Main" %CMD_LINE_ARGS%
